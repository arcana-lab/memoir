...
namespace object_abstraction {
  ...
  public:
     ...
     */
    inline CallInst * getFieldTypeAtIndex(int fieldIndex) { return this->fieldTypes[fieldIndex]; };
  ...
  public:
     ...
     * Tracking these access maybe unnecessary, leave it here for now to see can we justify their usage
     */
     ...
     */
    inline void setObjectDeletion(CallInst *deletion) { this->deletions.insert(deletion); };
