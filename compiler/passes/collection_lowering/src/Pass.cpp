...
#ifndef MEMOIR_PASS_NAME
#  define MEMOIR_PASS_NAME CollectionLowering
#endif
...
struct CollectionLoweringPass : public ModulePass {
  static char ID;

  CollectionLoweringPass() : ModulePass(ID) {}
...
char CollectionLoweringPass::ID = 0;
static RegisterPass<CollectionLoweringPass> X(
    "CollectionLowering",
    "Canonicalizes the slices of collections used with loops of the program.");

// Next there is code to register your pass to "clang"
static CollectionLoweringPass *_PassMaker = NULL;
static RegisterStandardPasses _RegPass1(
    PassManagerBuilder::EP_OptimizerLast,
    [](const PassManagerBuilder &, legacy::PassManagerBase &PM) {
      if (!_PassMaker) {
        PM.add(_PassMaker = new CollectionLoweringPass());
      }
    }); // ** for -Ox
