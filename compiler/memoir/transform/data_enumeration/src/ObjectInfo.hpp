#ifndef MEMOIR_TRANSFORMS_DATAENUMERATION_OBJECTINFO_H
#define MEMOIR_TRANSFORMS_DATAENUMERATION_OBJECTINFO_H
...
struct BaseObjectInfo : public ObjectInfo {
  ...
  AllocInst &allocation() const;

  BaseObjectInfo(AllocInst &alloc, OffsetsRef offsets = {})
