...
static inline void rotate_left(splay_tree_node *pp,
                               splay_tree_node p,
                               splay_tree_node n) {
  splay_tree_node tmp;
  tmp = n->right;
...
static inline void rotate_right(splay_tree_node *pp,
                                splay_tree_node p,
                                splay_tree_node n) {
  splay_tree_node tmp;
  tmp = n->left;
...
attribute_hidden splay_tree_key splay_tree_lookup(splay_tree sp,
                                                  splay_tree_key key) {
  splay_tree_splay(sp, key);
...
static void splay_tree_foreach_internal(splay_tree_node node,
...
attribute_hidden void splay_tree_foreach(splay_tree sp,
                                         splay_tree_callback func,
                                         void *data) {
