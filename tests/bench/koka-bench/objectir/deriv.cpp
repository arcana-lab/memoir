...
*/
Type *Expr = nameObjectType("Expr", getUInt8Type());
...
*/
Type *ValExpr = nameObjectType("ValExpr", getUInt64Type());
...
*/
Type *VarExpr = nameObjectType("VarExpr", 1, getPointerType(
