...
int main() {
  ...
  auto read_s00 = memoir_index_read(u64, slice_seq_03, 0);
  auto read_s01 = memoir_index_read(u64, slice_seq_03, 1);
  auto read_s02 = memoir_index_read(u64, slice_seq_03, 2);
  auto read_s03 = memoir_index_read(u64, slice_seq_03, 3);
  auto read_s10 = memoir_index_read(u64, slice_seq_45, 0);
  auto read_s11 = memoir_index_read(u64, slice_seq_45, 1);

  std::cout << " Result:\n";
  std::cout << "  HEAD -> " << std::to_string(read_s00) << "\n";
  std::cout << "       -> " << std::to_string(read_s01) << "\n";
  std::cout << "       -> " << std::to_string(read_s02) << "\n";
  std::cout << "       -> " << std::to_string(read_s03) << "\n\n";
