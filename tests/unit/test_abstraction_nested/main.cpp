...
int main() {
  ...
  Field *field1 = getStructField(outerObject, 0);
  Object *innerObject = readStruct(field1);
  Field *field11 = getStructField(innerObject, 0);
  writeUInt64(field11, 10);
  Field *field12 = getStructField(innerObject, 1);
  writeUInt64(field12, 20);

  Field *field2 = getStructField(outerObject, 1);
