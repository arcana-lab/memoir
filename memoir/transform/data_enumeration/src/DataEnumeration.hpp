#ifndef MEMOIR_TRANSFORMS_DATAENUMERATION_PROXYINSERTION_H
#define MEMOIR_TRANSFORMS_DATAENUMERATION_PROXYINSERTION_H
...
public:
  ...
  using GetBoundsChecks = std::function<BoundsCheckResult &(llvm::Function &)>;
...
protected:
  ...
  ObjectInfo *find_base_object(llvm::Value &V, AccessInst &access);
...
#endif // MEMOIR_TRANSFORMS_DATAENUMERATION_PROXYINSERTION_H
