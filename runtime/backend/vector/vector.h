...
#define INSTANTIATE_TYPED_NESTING_VECTOR(T, C_TYPE)                            \
  ...
  typedef T##_vector_t *T##_vector_p;                                          \
                                                                               \
  cname alwaysinline used T##_vector_p T##_vector__allocate(size_t n) {        \
    ...
    return alloc;                                                              \
                                                                               ...
                                                                               \
  cname alwaysinline used void T##_vector__free(T##_vector_p vec) {            \
    free(vec);                                                                 \
    return;                                                                    \
  }                                                                            \
                                                                               \
  cname alwaysinline used size_t T##_vector__size(T##_vector_p vec) {          \
    return vec->_back - vec->_front;                                           \
  }                                                                            \
                                                                               \
  cname alwaysinline used C_TYPE *T##_vector__get(const T##_vector_p vec,      \
                                                  size_t index) {              \
    return &vec->_storage[vec->_front + index];                                \
  }                                                                            \
                                                                               \
  cname alwaysinline used T##_vector_p T##_vector__remove(T##_vector_p vec,    \
                                                          size_t from,         \
                                                          size_t to) {         \
    ...
    return vec;                                                                \
                                                                               ...
                                                                               \
  cname alwaysinline used T##_vector_p T##_vector__insert_range(               \
      T##_vector_p vec,                                                        \
      size_t start,                                                            \
      T##_vector_p vec2,                                                       \
      size_t from,                                                             \
    ...
    return vec;                                                                \
                                                                               ...
                                                                               \
  cname alwaysinline used T##_vector_p T##_vector__insert(T##_vector_p vec,    \
                                                          size_t start,        \
                                                          T##_vector_p vec2) { \
    return T##_vector__insert_range(vec,                                       \
                                    ...
                                    vec2->_back - vec2->_front);               \
                                                                               ...
                                                                               \
  cname alwaysinline used T##_vector_p T##_vector__insert_element(             \
      T##_vector_p vec,                                                        \
      size_t start,                                                            \
      C_TYPE value) {                                                          \
    size_t vec_size = vec->_back - vec->_front;                                \
    ...
    return vec;                                                                \
                                                                               ...
                                                                               \
  cname alwaysinline used void T##_vector__swap(T##_vector_p vec,              \
                                                size_t from,                   \
                                                size_t to,                     \
                                                size_t start) {                \
...
#define INSTANTIATE_TYPED_VECTOR(T, C_TYPE)                                    \
  ...
  cname alwaysinline used size_t T##_vector__size(T##_vector_p vec) {          \
    return vec->_back - vec->_front;                                           \
                                                                               ...
                                                                               \
  cname alwaysinline used C_TYPE T##_vector__read(const T##_vector_p vec,      \
                                                  size_t index) {              \
    return vec->_storage[vec->_front + index];                                 \
  }                                                                            \
                                                                               \
  cname alwaysinline used void T##_vector__write(T##_vector_p vec,             \
                                                 size_t index,                 \
                                                 C_TYPE value) {               \
